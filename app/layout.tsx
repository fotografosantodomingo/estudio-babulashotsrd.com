    ...
    <html lang="es-DO" suppressHydrationWarning>
      ...
      <body>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html:
              "(function(){function l(){var s=document.createElement('script');s.async=true;s.src='https://chat.babulashotsrd.com/widget.js';s.dataset.bbSite='estudio';document.body.appendChild(s);}if(window.requestIdleCallback){window.requestIdleCallback(l,{timeout:3000})}else{window.addEventListener('load',function(){setTimeout(l,1000)})}})();"
          }}
        />
