  ...
  return (
    <div className="callback-wrap">
      ...
      <form
        ...
        aria-label={t.legend}
      >
        <input type="hidden" name="_subject" value="Babula Shots — nuevo callback (estudio)" />
        <input type="hidden" name="_next" value="https://estudio.babulashotsrd.com/?sent=ok" />
        ...
        <fieldset>
          ...
          <input type="hidden" name="niche" value="estudio" />
